...
INSERT INTO `pedido` (`id_cliente`, `fecha_pedido`, `fecha_entrega`, `pago` , `estado`, `total`, `comprobante_pago_url`) VALUES
(1, '2024-11-15 10:30:00', '2024-11-20 15:00:00', 'pendiente', 'pendiente', 499.99, NULL),
(2, '2024-11-14 08:15:00', '2024-11-18 12:00:00', 'realizado', 'en proceso', 1200.50, 'https://example.com/comprobantes/1202.pdf'),
(3, '2024-11-10 14:50:00', '2024-11-16 18:00:00', 'realizado', 'entregado', 299.99, 'https://example.com/comprobantes/1203.pdf'),
(4, '2024-11-05 16:40:00', '2024-11-10 17:00:00', 'pendiente', 'cancelado', 0.00, NULL);
